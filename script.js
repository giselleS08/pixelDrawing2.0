...
Position(pixel692, 2, 4);
Position(pixel693, 3, 4);
Position(pixel694, 4, 4);
Position(pixel695, 5, 4);
Position(pixel696, 6, 4);
Position(pixel697, 7, 4);
Position(pixel698, 8, 4);
Position(pixel699, 9, 4);
Position(pixel700, 10, 4);
Position(pixel701, 11, 4);
Position(pixel702, 12, 4);
Position(pixel703, 13, 4);
Position(pixel704, 14, 4);
Position(pixel705, 15, 4);
Position(pixel706, 16, 4);
Position(pixel707, 17, 4);
Position(pixel708, 18, 4);
Position(pixel709, 19, 4);
Position(pixel710, 20, 4);
Position(pixel711, 21, 4);
Position(pixel712, 22, 4);
Position(pixel713, 23, 4);
Position(pixel714, 24, 4);
Position(pixel715, 25, 4);
Position(pixel716, 26, 4);
Position(pixel717, 27, 4);
Position(pixel718, 28, 4);
Position(pixel719, 29, 4);
Position(pixel720, 30, 4);


//row5///////////////////////////////
Position(pixel721, 1, 5);
Position(pixel722, 2, 5);
Position(pixel723, 3, 5);
Position(pixel724, 4, 5);
Position(pixel725, 5, 5);
Position(pixel726, 6, 5);
Position(pixel727, 7, 5);
Position(pixel728, 8, 5);
Position(pixel729, 9, 5);
Position(pixel730, 10, 5);
Position(pixel731, 11, 5);
Position(pixel732, 12, 5);
Position(pixel733, 13, 5);
Position(pixel734, 14, 5);
Position(pixel735, 15, 5);
Position(pixel736, 16, 5);
Position(pixel737, 17, 5);
Position(pixel738, 18, 5);
Position(pixel739, 19, 5);
Position(pixel740, 20, 5);
Position(pixel741, 21, 5);
Position(pixel742, 22, 5);
Position(pixel743, 23, 5);
Position(pixel744, 24, 5);
Position(pixel745, 25, 5);
Position(pixel746, 26, 5);
Position(pixel747, 27, 5);
Position(pixel748, 28, 5);
Position(pixel749, 29, 5);
Position(pixel750, 30, 5);
////////////r0w 6/////////////////////////////////
x = 1
